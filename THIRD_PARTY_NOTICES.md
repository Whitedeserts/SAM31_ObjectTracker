...
| --- | --- | --- |
| SAM 3.1 model and SAM source | [Meta SAM License](https://huggingface.co/facebook/sam3.1/blob/main/LICENSE); supplied verbatim in LICENSE | Runtime source; checkpoint excluded from this repository |
...
| Original ArcGIS integration | See LICENSE_SCOPE.md; no separately supplied public license grant | Custom toolbox and supporting integration code |
