...
| Original ArcGIS integration | [CC BY-NC-SA 4.0](LICENSE); original contributions only, as described in [LICENSE_SCOPE.md](LICENSE_SCOPE.md) | Custom toolbox and supporting integration code |
